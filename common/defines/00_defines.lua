...
NDiplomacy = {
	...
	FRONT_IS_DANSAXOUS = -100,						-- AI should be unwilling to enter accept a call to war if front is too dangerous.
...
NNavy = {
	...
	NAVAL_MINE_DANSAX_TRIGSAX_MIN = 0.0,
	NAVAL_MINE_DANSAX_TRIGSAX_MAX = 2.0,
	
	NAVAL_CONVOY_DANSAX_RATIOS = {
		0.10,		-- not owned
	...
	NAVAL_CONVOY_DANSAX_TRIGSAX_MIN = 0.0,
	NAVAL_CONVOY_DANSAX_TRIGSAX_MAX = 100.0,
...
NAI = {
	...
	MAX_ALLOWED_NAVAL_DANSAX = 80,				-- AI will ignore naval paths that has danger value of above this threshold while assigning units
	TRANSFER_DANSAX_HOSTILE_SHIPS = 50, 		-- max danger from complete enemy naval supriority over ai in an area
	...
	REGION_CONVOY_DANSAX_DAILY_DECAY = 1,				-- When convoys are sunk it generates threat in the region which the AI uses to prio nalval missions
